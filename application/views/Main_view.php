<div class="row pad-top-30">
    ...
    <div class="col-md-4">
        <div class="list-group">
            <a href="<?php echo base_url(); ?>home" class="list-group-item <?php if(strpos($title, 'News Ro') !== false) echo 'active'; ?>">Home</a>
            <a href="<?php echo base_url(); ?>it" class="list-group-item <?php if(strpos($title, 'IT') !== false) echo 'active'; ?>">IT</a>
            <a href="<?php echo base_url(); ?>economic" class="list-group-item <?php if(strpos($title, 'Economic') !== false) echo 'active'; ?>">Economic</a>
            <a href="<?php echo base_url(); ?>social" class="list-group-item <?php if(strpos($title, 'Social') !== false) echo 'active'; ?>">Social</a>
            <a href="<?php echo base_url(); ?>sport" class="list-group-item <?php if(strpos($title, 'Sport') !== false) echo 'active'; ?>">Sport</a>
        </div>
